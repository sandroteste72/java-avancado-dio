...
//        IntStream.range(1,10000).forEach(num -> System.out.println(factorial(num)));
        ...
        System.out.println("Runtime Serial :: "+(end - start));

        start = System.currentTimeMillis();
        IntStream.range(1,100000).parallel().forEach(num -> factorial(num)); // Parallel stream
        end = System.currentTimeMillis();
        System.out.println("Runtime Parallel :: " + (end - start));

//        List<String> names = Arrays.asList("Joao","Paulo","Oliveira","Santos");
//        List<String> names2 = Arrays.asList("Joao","Oliveira","Paulo","Santos");
